    	...
    	<div class="info">
  	    ...
  	    <div class='text-left'>
  		    <ul style="list-style-type:square;">
  				...
  				<li><code>label</code> is an integer representation of a boolean; <code>0==FALSE</code> and <code>1==TRUE</code>. It is possible to upload data to Tasmia that is pre-labeled (i.e. the <code>label</code> column does not have to start with all zeros). See the <a href="/static/sample_trainset.csv" download>sample CSV</a>.</li>
  		    </ul>
  		  </div>
